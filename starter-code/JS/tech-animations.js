...
.from('.vehicle-sub1', {opacity: 0}, '-=1.5')
.from('.vehicle-title',{opacity: 0}, '-=1.5')
...
.from('.port-sub1',{duration: 2, opacity: 0}, '-=1.5')
.from('.port-title',{duration: 2, opacity: 0}, '-=1.5')
...
.from('.capsule-sub1',{duration: 2, opacity: 0}, '-=1.5')
.from('.capsule-title',{duration: 2, opacity: 0}, '-=1.5')
